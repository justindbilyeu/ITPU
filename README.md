...
- Surrogate testing with shuffle and block-bootstrap null distributions
- Benjamini-Hochberg FDR correction
- Statistical calibration verified: KS=0.0565, p=0.1497 under H₀

**What's coming:**
- IAAFT surrogates for autocorrelated/oscillatory data (#13)
...
itpu/
  ...
  stats/
    ...
    surrogates.py           # shuffle_surrogate, block_bootstrap_surrogate
...
tests/
  ...
  test_surrogates.py        # Surrogate shape, permutation, determinism (9 tests)
...
Correctness established. Surrogate testing framework shipped and calibrated. CI green at 40 tests.
